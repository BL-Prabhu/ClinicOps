...
public class AdminMenu
{
    ...
    public static void show(Scanner scanner) {
        ...
        while (!logout) {
            ...
            switch (choice) {
                case DOCTOR_ENTRY:
                    System.out.println("[Logic for Doctor Entry will be implemented]");
                    break;

                case BULK_ENTRY:
                    System.out.println("[Logic for Bulk CSV Upload will be implemented]");
                    break;

                case VIEW_AUDIT:
                    System.out.println("[Logic for Audit Logs will be implemented]");
                    break;
